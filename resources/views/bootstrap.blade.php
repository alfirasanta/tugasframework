                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><button class="dropdown-item" type="button"><small>
                                        <i class="bi-moon-stars-fill me-2"></i>Dark</small></button></li>
                                    <li><button class="dropdown-item" type="button"><small>
                                        <i class="bi-circle-half me-2"></i>Auto</small></button></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-md-7 order-md-1">
                    ...
                    <p class="fs-5 mt-3">Quickly design and customize responsive mobile-first sites with Bootstrap, the world's
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    ...
                    <div class="mt-2 text-muted">
                        <small>Designed and built with all the love in world by the <a href="#" class="text-black">
                            Bootstrap Team</a>with the help of <a href="#" class="text-black">our contributors</a></small>
                    </div>
                    <div class="mt-2 text-muted">
